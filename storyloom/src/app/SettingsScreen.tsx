...
export function SettingsScreen({workspace: w}: {workspace: Workspace}) {
  return <ScrollView contentContainerStyle={{padding: 30, paddingBottom: 60}}><View style={{maxWidth: 740, width: '100%', alignSelf: 'center', gap: 29}}>
    ...
    <View style={{gap: 6, alignItems: 'center', paddingVertical: 15}}><Text style={{fontSize: 21, color: colors.accent, fontWeight: '500', letterSpacing: 4}}>여백</Text><Text style={styles.small}>당신의 이야기가 머무는 곳 · 0.1.0</Text></View>
  </View></ScrollView>;
}

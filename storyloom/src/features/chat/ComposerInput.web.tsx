...
export function ComposerInput(p: ComposerInputProps) {
  ...
  useImperativeHandle(p.focusRef, () => ({focus: () => element.current?.focus()}), []);
  useLayoutEffect(() => {

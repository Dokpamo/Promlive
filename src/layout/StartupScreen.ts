...
const startup = (Platform.OS === 'android' ? NativeModules.PromliveStartup : undefined) as {theme: Theme; ready: (theme: Theme) => void} | undefined;

export function initialStartupTheme(): Theme {
  return startup?.theme === 'light' || startup?.theme === 'system' ? startup.theme : 'dark';
}

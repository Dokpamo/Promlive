...
// Not enabled by runtime.ts until the user configures a supported auth flow.
...
export class GrokProvider implements AiProvider {
  ...
  constructor(private readonly config: GrokConfiguration, private readonly credentials: CredentialStore, private readonly transport: TextStreamTransport) {

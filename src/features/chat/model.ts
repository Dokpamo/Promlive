...
export const conversationSchema = z.object({id: z.string(), cardId: z.string(), title: z.string(), createdAt: z.number().int(), updatedAt: z.number().int(), pinnedAt: z.number().int().nullable().optional(), preview: z.string().optional()});

...
export const conversationSchema = z.object({id: z.string(), cardId: z.string(), title: z.string(), createdAt: z.number().int(), updatedAt: z.number().int(), preview: z.string().optional()});

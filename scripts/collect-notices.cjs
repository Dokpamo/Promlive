...
for (const [source, target] of [
  ['ios/Pods/Target Support Files/Pods-Promlive/Pods-Promlive-acknowledgements.markdown', 'ios-pods.md'],
  ['macos/Pods/Target Support Files/Pods-promlive-macOS/Pods-promlive-macOS-acknowledgements.markdown', 'macos-pods.md'],
